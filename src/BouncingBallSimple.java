...
public class BouncingBallSimple extends JPanel {
   ...
   private float ballRadius2 = 100; // Ball's radius
   private float ballX2 = ballRadius2 + 50; // Ball's center (x, y)
   private float ballY2 = ballRadius2 + 20; 
   private float ballSpeedX2 = 2;   // Ball's speed for x and y
         ...
         public void run() {
            while (true) { // Execute one update step
               ...
               if (ballX2 - ballRadius2 < 0) {
                   ...
                   ballX2 = ballRadius2; // Re-position the ball at the edge
